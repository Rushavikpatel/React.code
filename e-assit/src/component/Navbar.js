      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme">
        ...
        <ul class="menu-inner py-1 ps ps--active-y">
          ...
          <li class="menu-item active">
            ...
            <Link to="/AddSchedule" className="menu-link">
            <i class="menu-icon tf-icons bx bx-box"></i>
             ADD Schedule
          ...
          <Link to="/Schedulemasterlist" className="menu-link">
          <i class="menu-icon tf-icons bx bx-box"></i>
          Schedule_Master List
          ...
          <Link to="/addDailyScheule/" className="menu-link">
          <i class="menu-icon tf-icons bx bx-box"></i>
         Add Daily Scheule
        ...
        <li class="menu-item active">
          ...
          <Link to='/addDailyScheuleDetailes' className="menu-link">
          <i class="menu-icon tf-icons bx bx-box"></i>
           Daily Scheule List
        ...
        <li class="menu-item active">
          ...
          <Link to='/AddRemider' className="menu-link">
          <i class="menu-icon tf-icons bx bx-box"></i>
           ADD Remider
        ...
        <li class="menu-item active">
          ...
          <Link to='/UserTaskList' className="menu-link">
          <i class="menu-icon tf-icons bx bx-box"></i>
           User Task List            
            <div data-i18n="Analytics"></div>
          </Link>
          ...
          {/*  <li class="menu-item">
            <a href="javascript:void(0)" class="menu-link menu-toggle">
              <i class="menu-icon tf-icons bx bx-box"></i>
              <div data-i18n="User interface">All View</div>
            </a> 
