...
export const ScheduleMasterList = () => {
  ...
  var style6 = {     width: "100%" , marginLeft:" 50%",marginTop:"10%"}
  ...
  const deleteSchedule = (id) => {
    axios
      .delete("http://localhost:4000/schedule_master/"+ id)
      .then((res) => {
         getSchedule_Masters();
      })
      .catch((err) => {
                        ...
                        >
                          <span>
                            ...
                            <span class="d-none d-sm-inline-block">
                              <Link to="/AddSchedule">change Schedule</Link>
                            </span>
                          </span>
                        </button>
                      </div>
                          ...
                          <td>
                            <div class="d-inline-block text-nowrap">
                              <button
                                ...
                                fdprocessedid="ltmjb"
                              >
                                <Link to ={`/ScheduleMasterdetailes/${u.Schedule._id}`}>
                                <i class="bx bx-edit">
