...
export const AddDailyScheduleDetailes = () => {
  ...
  const getDailySchedules = () => {
    axios.get("http://localhost:4000/daily_schedule/get").then((res) => {
  ...
  const deleteSchedule = (id) => {
    axios
      .delete("http://localhost:4000/daily_schedule/"+ id)
      .then((res) => {
        getDailySchedules();
      })
      .catch((err) => {
                        ...
                        >
                          <span>
                            ...
                            <span class="d-none d-sm-inline-block">
                              <Link to='/AddRemider'>ADD Remider</Link>
                            </span>
                          </span>
                        </button>
                      </div>
                          ...
                          <td class="sorting_1">
                            <div class="d-flex justify-content-start align-items-center user-name">
                              <div class="d-flex flex-column">
                                  ...
                                  <span class="fw-semibold">{u.forkdate}</span>
                          ...
                          <td class="sorting_1">
                            <div class="d-flex justify-content-start align-items-center user-name">
                              <div class="d-flex flex-column">
                                  ...
                                  <span class="fw-semibold">{u.forktime}</span>
                          ...
                          <td class="sorting_1">
                            <div class="d-flex justify-content-start align-items-center user-name">
                              <div class="d-flex flex-column">
                                  ...
                                  <span class="fw-semibold">{u.iscomplate}</span>
                          ...
                          <td class="sorting_1">
                            <div class="d-flex justify-content-start align-items-center user-name">
                              <div class="d-flex flex-column">
                                  ...
                                  <span class="fw-semibold">{u.priority_id}</span>
