...
export const UserTaskList = () => {
  ...
  var style6 = {     width: "100%" , marginLeft:"25%",marginTop:"10%"}
  ...
  const getTaskDetailes = () => {
    axios.get("http://localhost:4000/task/get").then((res) => {
                          ...
                          <td class="sorting_1">
                            <div class="d-flex justify-content-start align-items-center user-name">
                              <div class="d-flex flex-column">
                                  ...
                                  <span class="fw-semibold">{u.taskname}</span>
                          ...
                          <td class="sorting_1">
                            <div class="d-flex justify-content-start align-items-center user-name">
                              <div class="d-flex flex-column">
                                  ...
                                  <span class="fw-semibold">{u.description}</span>
                          ...
                          <td class="sorting_1">
                            <div class="d-flex justify-content-start align-items-center user-name">
                              <div class="d-flex flex-column">
                                  ...
                                  <span class="fw-semibold">{u.completiontime}</span>
                          ...
                          <td class="sorting_1">
                            <div class="d-flex justify-content-start align-items-center user-name">
                              <div class="d-flex flex-column">
                                  ...
                                  <span class="fw-semibold">{u.priority}</span>
